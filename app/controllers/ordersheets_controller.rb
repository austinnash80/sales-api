class OrdersheetsController < ApplicationController
  ...
  def import
    Ordersheet.import(params[:file])
    redirect_to ordersheets_path, notice: "Upload Complete"
  end
  ...
  private
    ...
    def ordersheet_params
      params.require(:ordersheet).permit(:uid, :license, :product_1, :product_2, :order_total, :pur_date, :f_name, :l_name, :address_1, :address_2, :city, :state, :zip, :email)
    end
end
